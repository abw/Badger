...
Added copy_file() and move_file() methods to Badger::Filesystem.
Added copy() and move() methods to Badger::Filesystem::File.

=head2 Version 0.06

Added L<debug_msg()|Badger::Base/debug_msg()> to L<Badger::Base>.
Also add C<Badger::Base::Trial> definition for use with the 
L<try()|Badger::Base/try()> method.

Added L<Badger::Log> and L<Badger::Log::File>.

Added L<Badger::Timestamp>.

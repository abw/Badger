...
in keeping the Badger fit and healthy.  But remember that you use it at your
own risk and it's not my fault if it doesn't make unicorns dance across the
sky for you.
...
L<http://github.com/abw/Template-TT2> and L<http://github.com/abw/Template-TT3>.

=head2 Version 0.10 - Not Yet released
...
Added no_config() method to L<Badger::Hub>.

Added L<Badger::Comparable> and L<Badger::Duration>.

Added L<plurality()|Badger::Utils/plurality()> and 
L<inflect()|Badger::Utils/inflect()> to L<Badger::Utils>.

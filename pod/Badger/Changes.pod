...
Added L<Badger::Storage> and L<Badger::Storage::Filesystem>.
...
Added the L<random_name()|Badger::Utils/random_name()> and
L<camel_case()|Badger::Utils/camel_case()> functions to L<Badger::Utils>. Also
add some extra debugging code to L<params()|Badger::Utils/params()> and
L<self_params()|Badger::Utils/self_params()> to catch any attempt to pass
an odd number of arguments.  

Added the L<debugf()|Badger::Debug/debugf()> and 
L<debug_at()|Badger::Debug/debug_at()> methods to 
L<Badger::Debug>.
...
data has now been moved into L<Badger::Hub::Badger>.
